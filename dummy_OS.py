...
def announcement_api_call():
    ann_list = ({"id": 23, "content": "Section A students come to class 313 for SS(tut)", "priority": "LOW", "authority": "Ashvini Shende"},
                {"id": 22, "content": "Monday is Thursday, because what's the Gregorian calander anyway? I make the rules around here", "priority": "HIGH", "authority": "Dr. Bahubali"},
                {"id": 21, "content": "Meow", "priority": "EH", "authority": "God all mighty"}
                )
    
    return ann_list
    
def timetable_api_call():
    timetable_list = (("9:30", "SS"),
                     ("10:30", "CN"),
                     ("11;30", "DBMS"))
...
def time_table_GUI(content):
    ...
    print(content[1][0], content[1][1])
    print(content[2][0], content[2][1])
